...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.644\angle 37.3^\circ$, so $|\Gamma_L| = 0.644$ sets the SWR-circle radius and $S = 4.62$.
\end{itemize}
\lead{Step 2 --- draw the SWR circle and read (a) and (b)}
\begin{itemize}
  \item Centre the compass on the chart centre and swing a circle through $z_L$. Its radius is $|\Gamma_L| = 0.644$ of the chart radius.
  \item \textbf{(a)} $\Gamma_L = 0.644\angle 37.3^\circ$ --- read the angle on the \emph{angle of reflection coefficient} scale.
  \item \textbf{(b)} The circle cuts the right-hand real axis at $r = 4.62$, and on that axis $r = S$, so $\boxed{S = 4.62}$.
\end{itemize}
...
\figC{c2num_p01.png}{0.55\textwidth}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.637\angle 35.7^\circ$, so $|\Gamma_L| = 0.637$ sets the SWR-circle radius and $S = 4.50$.
\end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    \item $y_1 = 1.00 + j1.65$ at $0.180\lambda$ WTG, so $d_1 = 0.180\lambda - 0.450\lambda = 0.230\lambda$.
    \item $y_2 = 1.00 - j1.65$ at $0.320\lambda$ WTG, so $d_2 = 0.320\lambda - 0.450\lambda = 0.370\lambda$.
  \end{itemize}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.500\angle 51.0^\circ$, so $|\Gamma_L| = 0.500$ sets the SWR-circle radius and $S = 3.00$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Rotate \textbf{clockwise} (toward the generator) to each intersection with the \textbf{$g=1$ circle}. There are always two:
  \begin{itemize}
    \item $y_1 = 1.00 + j1.15$ at $0.167\lambda$ WTG, so $d_1 = 0.167\lambda - 0.429\lambda = 0.237\lambda$.
    \item $y_2 = 1.00 - j1.15$ at $0.333\lambda$ WTG, so $d_2 = 0.333\lambda - 0.429\lambda = 0.404\lambda$.
  \end{itemize}
  \item Only the \emph{susceptance} is left to cancel: the conductance is already 1.
\end{itemize}
\lead{Step 4 --- read each stub length off the rim}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.593\angle -46.8^\circ$, so $|\Gamma_L| = 0.593$ sets the SWR-circle radius and $S = 3.91$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Rotate \textbf{clockwise} (toward the generator) to each intersection with the \textbf{$g=1$ circle}. There are always two:
  \begin{itemize}
    \item $y_1 = 1.00 + j1.47$ at $0.175\lambda$ WTG, so $d_1 = 0.175\lambda - 0.065\lambda = 0.110\lambda$.
    \item $y_2 = 1.00 - j1.47$ at $0.325\lambda$ WTG, so $d_2 = 0.325\lambda - 0.065\lambda = 0.259\lambda$.
  \end{itemize}
  \item Only the \emph{susceptance} is left to cancel: the conductance is already 1.
\end{itemize}
\lead{Step 4 --- read each stub length off the rim}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.594\angle -68.8^\circ$, so $|\Gamma_L| = 0.594$ sets the SWR-circle radius and $S = 3.93$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Rotate \textbf{clockwise} (toward the generator) to each intersection with the \textbf{$g=1$ circle}. There are always two:
  \begin{itemize}
    \item $y_1 = 1.00 + j1.48$ at $0.176\lambda$ WTG, so $d_1 = 0.176\lambda - 0.096\lambda = 0.080\lambda$.
    \item $y_2 = 1.00 - j1.48$ at $0.324\lambda$ WTG, so $d_2 = 0.324\lambda - 0.096\lambda = 0.229\lambda$.
  \end{itemize}
  \item Only the \emph{susceptance} is left to cancel: the conductance is already 1.
\end{itemize}
\lead{Step 4 --- read each stub length off the rim}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.371\angle 42.5^\circ$, so $|\Gamma_L| = 0.371$ sets the SWR-circle radius and $S = 2.18$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Rotate \textbf{clockwise} (toward the generator) to each intersection with the \textbf{$g=1$ circle}. There are always two:
  \begin{itemize}
    \item $y_1 = 1.00 + j0.80$ at $0.155\lambda$ WTG, so $d_1 = 0.155\lambda - 0.441\lambda = 0.214\lambda$.
    \item $y_2 = 1.00 - j0.80$ at $0.345\lambda$ WTG, so $d_2 = 0.345\lambda - 0.441\lambda = 0.404\lambda$.
  \end{itemize}
  \item Only the \emph{susceptance} is left to cancel: the conductance is already 1.
\end{itemize}
\lead{Step 4 --- read each stub length off the rim}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.370\angle 65.2^\circ$, so $|\Gamma_L| = 0.370$ sets the SWR-circle radius and $S = 2.17$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Rotate \textbf{clockwise} (toward the generator) to each intersection with the \textbf{$g=1$ circle}. There are always two:
  \begin{itemize}
    \item $y_1 = 1.00 + j0.80$ at $0.155\lambda$ WTG, so $d_1 = 0.155\lambda - 0.409\lambda = 0.246\lambda$.
    \item $y_2 = 1.00 - j0.80$ at $0.345\lambda$ WTG, so $d_2 = 0.345\lambda - 0.409\lambda = 0.435\lambda$.
  \end{itemize}
  \item Only the \emph{susceptance} is left to cancel: the conductance is already 1.
\end{itemize}
\lead{Step 4 --- read each stub length off the rim}
...
{\color{sub}\footnotesize \yr{71 Bh} \gap$\cdot$\gap $Z_0 = 300\,\Omega$}

\begin{asked}{71 Bh \ [10]}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.447\angle 63.4^\circ$, so $|\Gamma_L| = 0.447$ sets the SWR-circle radius and $S = 2.62$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Follow that circle to where it cuts the spacing circle. It cuts twice, giving the two standard solutions:
  \begin{itemize}
    \item \textbf{Solution A}: $y_a = 0.50 - j1.87$, so stub 1 must add $b_1 = -1.866 - (-0.500) = -1.366$.
    \item \textbf{Solution B}: $y_a' = 0.50 - j0.13$, so $b_1' = +0.366$.
  \end{itemize}
...
\figC{c2num_p08.png}{0.55\textwidth}
{\footnotesize\color{sub} Problem 8 --- Smith chart construction. Arcs are numbered in the order of the steps above.}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.711\angle 51.3^\circ$, so $|\Gamma_L| = 0.711$ sets the SWR-circle radius and $S = 5.93$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Follow that circle to where it cuts the spacing circle. It cuts twice, giving the two standard solutions:
  \begin{itemize}
    \item \textbf{Solution A}: $y_a = 0.21 - j1.61$, so stub 1 must add $b_1 = -1.608 - (-0.464) = -1.144$.
    \item \textbf{Solution B}: $y_a' = 0.21 - j0.39$, so $b_1' = +0.072$.
  \end{itemize}
...
\figC{c2num_p09.png}{0.55\textwidth}
{\footnotesize\color{sub} Problem 9 --- Smith chart construction. Arcs are numbered in the order of the steps above.}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.458\angle 29.9^\circ$, so $|\Gamma_L| = 0.458$ sets the SWR-circle radius and $S = 2.69$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Follow that circle to where it cuts the spacing circle. It cuts twice, giving the two standard solutions:
  \begin{itemize}
    \item \textbf{Solution A}: $y_a = 0.39 - j1.80$, so stub 1 must add $b_1 = -1.796 - (-0.228) = -1.567$.
    \item \textbf{Solution B}: $y_a' = 0.39 - j0.20$, so $b_1' = +0.024$.
  \end{itemize}
...
\figC{c2num_p10.png}{0.55\textwidth}
{\footnotesize\color{sub} Problem 10 --- Smith chart construction. Arcs are numbered in the order of the steps above.}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.620\angle 60.3^\circ$, so $|\Gamma_L| = 0.620$ sets the SWR-circle radius and $S = 4.27$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Follow that circle to where it cuts the spacing circle. It cuts twice, giving the two standard solutions:
  \begin{itemize}
    \item \textbf{Solution A}: $y_a = 0.31 - j1.72$, so stub 1 must add $b_1 = -1.722 - (-0.538) = -1.183$.
    \item \textbf{Solution B}: $y_a' = 0.31 - j0.28$, so $b_1' = +0.260$.
  \end{itemize}
...
\figC{c2num_p11.png}{0.55\textwidth}
{\footnotesize\color{sub} Problem 11 --- Smith chart construction. Arcs are numbered in the order of the steps above.}

\penalty0\vspace{2pt}

%======================================================================
\Q{Problem 12 --- Double-stub shunt tuner}{\m{3}\m{15}}
{\color{sub}\footnotesize \yr{69 Bh} \gap$\cdot$\gap $Z_0 = 50\,\Omega$}

\begin{asked}{69 Bh \ [3+15]}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.542\angle 40.6^\circ$, so $|\Gamma_L| = 0.542$ sets the SWR-circle radius and $S = 3.37$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Follow that circle to where it cuts the spacing circle. It cuts twice, giving the two standard solutions:
  \begin{itemize}
    \item \textbf{Solution A}: $y_a = 0.33 - j1.75$, so stub 1 must add $b_1 = -1.745 - (-0.333) = -1.412$.
    \item \textbf{Solution B}: $y_a' = 0.33 - j0.25$, so $b_1' = +0.079$.
  \end{itemize}
...
\figC{c2num_p12.png}{0.55\textwidth}
{\footnotesize\color{sub} Problem 12 --- Smith chart construction. Arcs are numbered in the order of the steps above.}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.450\angle 52.5^\circ$, so $|\Gamma_L| = 0.450$ sets the SWR-circle radius and $S = 2.63$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Follow that circle to where it cuts the spacing circle. It cuts twice, giving the two standard solutions:
  \begin{itemize}
    \item \textbf{Solution A}: $y_a = 0.46 - j1.84$, so stub 1 must add $b_1 = -1.839 - (-0.408) = -1.431$.
    \item \textbf{Solution B}: $y_a' = 0.46 - j0.16$, so $b_1' = +0.247$.
  \end{itemize}
...
\figC{c2num_p13.png}{0.55\textwidth}
{\footnotesize\color{sub} Problem 13 --- Smith chart construction. Arcs are numbered in the order of the steps above.}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.635\angle 94.0^\circ$, so $|\Gamma_L| = 0.635$ sets the SWR-circle radius and $S = 4.48$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Follow that circle to where it cuts the spacing circle. It cuts twice, giving the two standard solutions:
  \begin{itemize}
    \item \textbf{Solution A}: $y_a = 0.45 - j1.84$, so stub 1 must add $b_1 = -1.837 - (-0.963) = -0.874$.
    \item \textbf{Solution B}: $y_a' = 0.45 - j0.16$, so $b_1' = +0.800$.
  \end{itemize}
...
\figC{c2num_p14.png}{0.55\textwidth}
{\footnotesize\color{sub} Problem 14 --- Smith chart construction. Arcs are numbered in the order of the steps above.}
...
\begin{itemize}
  ...
  \item Follow that circle to where it cuts the spacing circle. It cuts twice, giving the two standard solutions:
  \begin{itemize}
    \item \textbf{Solution A}: $y_a = 0.27 - j1.68$, so stub 1 must add $b_1 = -1.681 - (-0.208) = -1.473$.
    \item \textbf{Solution B}: $y_a' = 0.27 - j0.32$, so $b_1' = -0.111$.
  \end{itemize}
...
\figC{c2num_p15.png}{0.55\textwidth}
{\footnotesize\color{sub} Problem 15 --- Smith chart construction. Arcs are numbered in the order of the steps above.}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.568\angle 41.1^\circ$, so $|\Gamma_L| = 0.568$ sets the SWR-circle radius and $S = 3.63$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Follow that circle to where it cuts the spacing circle. It cuts twice, giving the two standard solutions:
  \begin{itemize}
    \item \textbf{Solution A}: $y_a = 0.31 - j1.72$, so stub 1 must add $b_1 = -1.725 - (-0.342) = -1.382$.
    \item \textbf{Solution B}: $y_a' = 0.31 - j0.28$, so $b_1' = +0.067$.
  \end{itemize}
...
\figC{c2num_p16.png}{0.55\textwidth}
{\footnotesize\color{sub} Problem 16 --- Smith chart construction. Arcs are numbered in the order of the steps above.}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.640\angle 58.0^\circ$, so $|\Gamma_L| = 0.640$ sets the SWR-circle radius and $S = 4.56$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Follow that circle to where it cuts the spacing circle. It cuts twice, giving the two standard solutions:
  \begin{itemize}
    \item \textbf{Solution A}: $y_a = 0.28 - j1.70$, so stub 1 must add $b_1 = -1.697 - (-0.520) = -1.177$.
    \item \textbf{Solution B}: $y_a' = 0.28 - j0.30$, so $b_1' = +0.217$.
  \end{itemize}
...
\figC{c2num_p17.png}{0.55\textwidth}
{\footnotesize\color{sub} Problem 17 --- Smith chart construction. Arcs are numbered in the order of the steps above.}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.469\angle -41.7^\circ$, so $|\Gamma_L| = 0.469$ sets the SWR-circle radius and $S = 2.76$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Follow that circle to where it cuts the spacing circle. It cuts twice, giving the two standard solutions:
  \begin{itemize}
    \item \textbf{Solution A}: $y_a = 0.43 - j1.82$, so stub 1 must add $b_1 = -1.818 - (0.385) = -2.203$.
    \item \textbf{Solution B}: $y_a' = 0.43 - j0.18$, so $b_1' = -0.567$.
  \end{itemize}
...
\figC{c2num_p18.png}{0.55\textwidth}
{\footnotesize\color{sub} Problem 18 --- Smith chart construction. Arcs are numbered in the order of the steps above.}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.330\angle 66.0^\circ$, so $|\Gamma_L| = 0.330$ sets the SWR-circle radius and $S = 1.99$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Follow that circle to where it cuts the spacing circle. It cuts twice, giving the two standard solutions:
  \begin{itemize}
    \item \textbf{Solution A}: $y_a = 0.65 - j1.94$, so stub 1 must add $b_1 = -1.936 - (-0.438) = -1.498$.
    \item \textbf{Solution B}: $y_a' = 0.65 - j0.06$, so $b_1' = +0.373$.
  \end{itemize}
...
\figC{c2num_p19.png}{0.55\textwidth}
{\footnotesize\color{sub} Problem 19 --- Smith chart construction. Arcs are numbered in the order of the steps above.}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.450\angle 60.0^\circ$, so $|\Gamma_L| = 0.450$ sets the SWR-circle radius and $S = 2.64$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Follow that circle to where it cuts the spacing circle. It cuts twice, giving the two standard solutions:
  \begin{itemize}
    \item \textbf{Solution A}: $y_a = 0.48 - j1.86$, so stub 1 must add $b_1 = -1.856 - (-0.472) = -1.384$.
    \item \textbf{Solution B}: $y_a' = 0.48 - j0.14$, so $b_1' = +0.327$.
  \end{itemize}
...
\figC{c2num_p20.png}{0.55\textwidth}
{\footnotesize\color{sub} Problem 20 --- Smith chart construction. Arcs are numbered in the order of the steps above.}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.466\angle 57.2^\circ$, so $|\Gamma_L| = 0.466$ sets the SWR-circle radius and $S = 2.74$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Follow that circle to where it cuts the spacing circle. It cuts twice, giving the two standard solutions:
  \begin{itemize}
    \item \textbf{Solution A}: $y_a = 0.45 - j1.84$, so stub 1 must add $b_1 = -1.838 - (-0.455) = -1.384$.
    \item \textbf{Solution B}: $y_a' = 0.45 - j0.16$, so $b_1' = +0.293$.
  \end{itemize}
...
\figC{c2num_p21.png}{0.55\textwidth}
{\footnotesize\color{sub} Problem 21 --- Smith chart construction. Arcs are numbered in the order of the steps above.}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.447\angle 26.6^\circ$, so $|\Gamma_L| = 0.447$ sets the SWR-circle radius and $S = 2.62$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Follow that circle to where it cuts the spacing circle. It cuts twice, giving the two standard solutions:
  \begin{itemize}
    \item \textbf{Solution A}: $y_a = 0.40 - j1.80$, so stub 1 must add $b_1 = -1.800 - (-0.200) = -1.600$.
    \item \textbf{Solution B}: $y_a' = 0.40 - j0.20$, so $b_1' = +0.000$.
  \end{itemize}
...
\figC{c2num_p22.png}{0.55\textwidth}
{\footnotesize\color{sub} Problem 22 --- Smith chart construction. Arcs are numbered in the order of the steps above.}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.555\angle -93.9^\circ$, so $|\Gamma_L| = 0.555$ sets the SWR-circle radius and $S = 3.49$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Follow that circle to where it cuts the spacing circle. It cuts twice, giving the two standard solutions:
  \begin{itemize}
    \item \textbf{Solution A}: $y_a = 0.56 - j1.90$, so stub 1 must add $b_1 = -1.899 - (0.899) = -2.798$.
    \item \textbf{Solution B}: $y_a' = 0.56 - j0.10$, so $b_1' = -1.000$.
  \end{itemize}
...
\figC{c2num_p23.png}{0.55\textwidth}
{\footnotesize\color{sub} Problem 23 --- Smith chart construction. Arcs are numbered in the order of the steps above.}
...
\begin{itemize}
  ...
  \item $\Gamma_L = (z_L-1)/(z_L+1) = 0.500\angle 90.0^\circ$, so $|\Gamma_L| = 0.500$ sets the SWR-circle radius and $S = 3.00$.
\end{itemize}
\lead{Step 2 --- convert to admittance}
\begin{itemize}
  \item Draw the diameter through $z_L$ and read the opposite intersection --- a $\lambda/4$ half-turn. On an immittance chart read the amber grid in place and skip this step.
...
\begin{itemize}
  ...
  \item Follow that circle to where it cuts the spacing circle. It cuts twice, giving the two standard solutions:
  \begin{itemize}
    \item \textbf{Solution A}: $y_a = 0.60 - j1.92$, so stub 1 must add $b_1 = -1.917 - (-0.800) = -1.117$.
    \item \textbf{Solution B}: $y_a' = 0.60 - j0.08$, so $b_1' = +0.717$.
  \end{itemize}
...
\figC{c2num_p24.png}{0.55\textwidth}
{\footnotesize\color{sub} Problem 24 --- Smith chart construction. Arcs are numbered in the order of the steps above.}
