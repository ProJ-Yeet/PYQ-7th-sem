...
{\color{sub}\footnotesize 3 hrs \gap$\cdot$\gap asked in \mk{21 of 24 papers}
...
\begin{enumerate}[label=\arabic*., leftmargin=1.4em, itemsep=1pt]
  \item \textbf{Conventional low frequency vs RF/microwave circuit behavior} (asked in 21 papers) $\rightarrow$ contrast lumped vs distributed analysis ($d \ll \lambda$ vs $d \gtrsim 0.01\lambda$), breakdown of Kirchhoff's laws, skin effect, and equivalent circuit parasitics of $R$, $L$, $C$.
  \item \textbf{Detailed real-world protocols and specifications of microwave communication systems} (asked in 19 papers) $\rightarrow$ prepare full parametric tables for GSM 900/1800, Satellite C/Ku-band, Terrestrial Microwave link, and WiFi 802.11.
  \item \textbf{IEEE microwave frequency band classification} (asked in 6 papers) $\rightarrow$ memorise the letter-code frequency boundaries (L, S, C, X, Ku, K, Ka, mmWave) and their primary application.
\end{enumerate}
...
{\color{sub}\footnotesize \tF{6} \yr{\textbf{70 Bh}, 70 Ma, \textbf{76 Bh}, \texttt{80 Ba}, \textbf{\texttt{79 Bh}}, \texttt{82 Ba}, 69 Bh} \gap$\cdot$\gap standard frequency classification}
...
\begin{itemize}
  ...
  \end{itemize}
  \item \textbf{Unique molecular resonance}:
  \begin{itemize}
    \item Water molecules absorb $2.45\text{ GHz}$ $\rightarrow$ efficient dielectric heating (cooking, industrial drying).
  \end{itemize}
\end{itemize}
...
{\color{sub}\footnotesize \tS{21} \yr{\textbf{70 Bh}, 70 Ma, 71 Ma, \textbf{72 Ash}, 72 Ma, \textbf{73 Bh}, 73 Ma, \textbf{75 Bh}, \textbf{76 Bh}, \textbf{77 Ch}, \textbf{78 Ch}, \textbf{79 Ch}, \texttt{80 Ba}, \textbf{\texttt{80 Bh}}, \textbf{80 Ch}, \textbf{\texttt{81 Bh}}, \texttt{81 Ba}, \textbf{\texttt{82 Bh}}, \texttt{82 Ba}, 69 Bh} \gap$\cdot$\gap top repeated topic}
...
{\color{sub}\footnotesize \tS{15} \yr{\textbf{70 Bh}, 70 Ma, 71 Ma, \textbf{72 Ash}, \textbf{73 Bh}, 73 Ma, 74 Ma, \textbf{78 Ch}, \texttt{80 Ba}, \textbf{80 Ch}, \textbf{\texttt{79 Bh}}, \textbf{\texttt{81 Bh}}} \gap$\cdot$\gap core justification}
...
{\color{sub}\footnotesize \tF{5} \yr{\textbf{70 Bh}, \textbf{77 Ch}, \textbf{79 Ch}, \textbf{\texttt{80 Bh}}, \textbf{\texttt{82 Bh}}} \gap$\cdot$\gap equivalent circuits and frequency responses}
...
{\color{sub}\footnotesize \tS{19} \yr{\textbf{70 Bh}, 70 Ma, \textbf{73 Bh}, \textbf{76 Bh}, \textbf{77 Ch}, \textbf{78 Ch}, \textbf{\texttt{79 Bh}}, \textbf{\texttt{80 Bh}}, \texttt{81 Ba}, \textbf{\texttt{81 Bh}}, \textbf{\texttt{82 Bh}}, \texttt{82 Ba}} \gap$\cdot$\gap top repeated exam requirement}
...
\midrule
\textbf{Operating band} & UHF / L-band ($900/1800\text{ MHz}$) & Ku-band ($12\text{--}18\text{ GHz}$) & C / X-band ($6\text{--}11\text{ GHz}$) & S / C-band ($2.4\text{ \& }5\text{ GHz}$) & S-band ($2.7\text{--}2.9\text{ GHz}$) \\
\textbf{Uplink / Tx Freq} & $890\text{--}915\text{ MHz}$ (GSM 900) & $14.0\text{--}14.5\text{ GHz}$ & $5.925\text{--}6.425\text{ GHz}$ & $5.15\text{--}5.85\text{ GHz}$ & $2.7\text{--}2.9\text{ GHz}$ pulsed \\
\textbf{Downlink / Rx Freq} & $935\text{--}960\text{ MHz}$ (GSM 900) & $11.7\text{--}12.2\text{ GHz}$ & $3.700\text{--}4.200\text{ GHz}$ & $5.15\text{--}5.85\text{ GHz}$ & Reflected echo \\
