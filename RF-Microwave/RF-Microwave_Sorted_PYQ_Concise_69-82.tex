...
\begin{itemize}
  \item Microwave frequency bands (IEEE) + applications; comm protocols of three / five systems \hfill (4)(2+4)(3+3)(2+6)(4+6)(5+5)
...
\begin{itemize}
  ...
  \item S-parameters --- two-port (derive); three-port network + characteristic parameters +Eg \hfill (2+6)(4+5)(4+4)(2+6)
...
\begin{itemize}
  \item Waveguide --- rect TE/TM field equations; modes + parameters \hfill (7+3)(8+2)(8)(10)
    \begin{itemize}
      ...
      \item dominant Vs degenerate modes; $a{=}3b$ dominant mode; rect WG (assumed dims): cutoff, $v_p$, $\lambda_g$, $Z_0$ \hfill (2+2)(6)
...
\begin{itemize}
  ...
  \item Klystron oscillator/amplifier (multi-cavity); cross-field effect; velocity modulation + reflex klystron +Fig \hfill (2+7)(2+8)(5)(10)
...
\begin{itemize}
  ...
  \item LPF/HPF/BPF via microstrip ($\pi$-section, T-type, series-arm, shunt-arm, double-section, triple-pad) +prototyping \hfill (3+5)(6+4)(10)(7+3)(2+8)(8+2)(5+3)
  \item Amplifier --- stability + max gain (bilateral \& unilateral), +Smith, +flowchart \hfill (5+5)(10)(12)(18)(7+8)(8+4)
    \begin{itemize}
...
\begin{itemize}
  ...
  \item Calorimeter --- static / dry / circulating Vs flow; calorimeter wattmeter; static + dynamic circulating \hfill (5)(2+8)(6+2)(10)(6+3)
