...
The only chapter asked in every paper. Three blocks, each with a fixed pattern:
...
\sbs{%
\lead{McClelland's theory of learned needs}
...
\end{itemize}}{%
\lead{Fear and punishment theory \m{4}}
...
\begin{itemize}
  ...
  \item 81 Bh's ``State Maslow's need theory with examples [3]'' is filed under Ch.\,1
    (theories of management) in the Detailed PYQ; it is answered here.
\end{itemize}
...
\begin{itemize}
  \item AJ Sir slide 10: Maslow's theory is from 1943 (``A Theory of Human Motivation''),
    not ``the 1940s'' vaguely; slide 25: the grid's co-author is \textbf{Jane} Mouton, not
    ``Jake''.
  \item Adhikari p213: the fear and punishment slide describes criminal deterrence; the
    workplace version is summarized above.
  \item Adhikari p249: McClelland was at Harvard (``Horward'' in the source).
\end{itemize}
