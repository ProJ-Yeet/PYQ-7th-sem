% =====================================================================
%  Organization and Management — Exam Notes : shared preamble
%  Adapted from RF-Microwave, Wireless & Data Mining ExamNotes.
...
\newcommand{\tS}[1]{\pill{mkc}{white}{TOP\, #1/29}}            % 8+ papers (out of 29)
\newcommand{\tF}[1]{\pill{acc}{white}{HOT\, #1/29}}            % 4-7 papers
\newcommand{\tP}[1]{\pill{pin}{white}{PIN\, #1/29}}            % 1-3, >=6 marks
\newcommand{\tL}[1]{\pill{ruleL}{sub}{LOW\, #1/29}}            % 1-3, under 6 marks
\newcommand{\tN}{\pillo{sub}{syllabus, no PYQ yet}}            % never examined
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\footnotesize\color{sub} Organization and Management \textperiodcentered{} ME 708}
