...
{\color{sub}\footnotesize \yr{76 Ch} \gap ``If the probability that a normal object is classified as
an anomaly is 0.01 and the probability that an anomalous object is classified as anomalous is 0.99,
then what is the false alarm rate and detection rate if 99\% of the objects are normal?''}
...
{\color{sub}\footnotesize Same detector, but anomalies are 1 in 1,000 instead of 1 in 100.
Shows how fast the Bayesian rate collapses. \added}
...
\lead{Problem} Points $P_1(1,1)$, $P_2(1,2)$, $P_3(2,1)$, $P_4(2,2)$, $P_5(8,8)$.
Take $r = 2$, $\pi = 0.4$. Which points are DB$(2, 0.4)$-outliers? Use Euclidean distance.
