...
\end{itemize}
\lead{The taxonomy, drawn}
\figT{c7_web_taxonomy.png}
{\color{sub}\scriptsize The three branches and their sub-branches, exactly the list on the right.
Draw this tree first, then explain each box. Mishra's Ch 6 \& 7 notes, p6.}}{%
...
\end{itemize}
\mbox{}\hfill\includegraphics[width=0.62\linewidth]{figs/c7_timeseries.png}\hfill\mbox{}\par
{\color{sub}\scriptsize A stock price series (solid) and its 10-day moving average (dashed):
smoothing strips the irregular part and leaves the \textbf{trend}. H\&K Fig 13.2.}}{%
\lead{Tasks}
\begin{itemize}
