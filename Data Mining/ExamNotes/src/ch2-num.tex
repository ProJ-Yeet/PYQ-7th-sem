...
\end{itemize}
\includegraphics[width=\linewidth]{figs/c2n_boxplot_74.png}
{\color{sub}\scriptsize Drawn to scale by \code{boxfig.py} from the values above. The whisker
stops at 70, not at the fence.}}
