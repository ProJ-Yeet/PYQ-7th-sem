...
data points.
\par\vspace{2pt}
\begin{tabularx}{0.72\textwidth}{@{}L{1.1cm}XXXXX@{}}
\toprule
\hrow & \thead{$p_1$} & \thead{$p_2$} & \thead{$p_3$} & \thead{$p_4$} & \thead{$p_5$} \\
$p_1$ & 0.00 & 0.24 & 0.22 & 0.37 & 0.34 \\
$p_2$ & 0.24 & 0.00 & 0.15 & 0.20 & 0.14 \\
$p_3$ & 0.22 & 0.15 & 0.00 & 0.15 & 0.28 \\
$p_4$ & 0.37 & 0.20 & 0.15 & 0.00 & 0.29 \\
$p_5$ & 0.34 & 0.14 & 0.28 & 0.29 & 0.00 \\
$p_6$ & 0.23 & 0.25 & 0.11 & 0.22 & 0.39 \\
\bottomrule
\end{tabularx}
\par\vspace{2pt}
{\color{sub}The paper prints the full symmetric $6\times6$; the $p_6$ column is
0.23, 0.25, 0.11, 0.22, 0.39, 0.00.}
\end{asked}
{\color{sub}\footnotesize Distances are given directly, so no coordinate work.
The paper does not name a linkage --- use \textbf{single link} and say so.}
...
\end{asked}
{\color{sub}\footnotesize No PYQ sets a DBSCAN numerical, but the algorithm is asked in 8 papers
and a worked classification makes the definitions concrete. \added}
