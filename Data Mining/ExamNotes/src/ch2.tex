...
{\color{sub}\footnotesize 6 hrs \gap$\cdot$\gap in 23/23 papers \gap$\cdot$\gap 4 topics, 2 TOP tier
...
{\color{sub}\footnotesize \tS{16} \yr{82 Bh, 81 Ba, 79 Ba, 75 Ch, 73 Ch, 72 Ka, 69 Ch} \gap Most-asked topic in the syllabus.}
...
{\color{sub}\footnotesize \tS{} \yr{79 Ba, 78 Bh, 75 Ch, 73 Shr} \gap \textbf{Normalisation numerical is a
...
\end{itemize}
\lead{The four forms at a glance}
\mbox{}\hfill\includegraphics[width=0.78\linewidth]{figs/c2_preproc_forms.png}\hfill\mbox{}\par
{\color{sub}\scriptsize Cleaning, integration, reduction (attributes A1..A126 to A1..A115,
tuples T1..T2000 to fewer), transformation ($-2, 32, 100 \rightarrow -0.02, 0.32, 1.00$).
The one-figure answer to ``forms of preprocessing''. H\&K Fig 3.1.}}
...
{\color{sub}\footnotesize \tS{13} \yr{81 Bh, 79 Bh, 75 Ash, 74 Ch, 73 Ch, 72 Ch, 70 Asa}}
...
{\color{sub}\footnotesize \tF{7} \yr{80 Bh, 80 Ba, 78 Bh, 76 Ch, 76 Ash, 71 Ch, 70 Asa}
...
\textbf{Never asked in the 23 papers}, so no tier chip. Added because PC's 2025--26 Unit 2 handout
...
\end{itemize}
\mbox{}\hfill\includegraphics[width=0.68\linewidth]{figs/c2_boxplot_hk.png}\hfill\mbox{}\par
{\color{sub}\scriptsize Four boxplots side by side: box $Q_1$ to $Q_3$, median line, whiskers,
and Branch 1's two outliers plotted as lone points above its whisker. H\&K Fig 2.3.}}{%
...
{\color{sub}\footnotesize Tiers: \tS{} $=$ 9+/23 \gap \tF{} $=$ 5--8 \gap \tP{} $=$ 1--4 but $\ge$8 marks.
...
\begin{itemize}
  \item What is performed during preprocessing? $+$ techniques to handle missing values. \hfill \m{4+4} \yr{82 Bh}
  \item \textbf{Curse of dimensionality} in data mining. \hfill \m{6} \yr{81 Bh}
  \item Why are similarity measures important? $+$ the different measures w/ examples. \hfill \m{2+6} \yr{81 Bh}
  \item \mk{N} Bin means at depth 3 $+$ min-max $+$ z-score $+$ decimal scaling of 35, on 27 values. \hfill \m{6} \yr{79 Ba}
  \item Nominal and ordinal attributes $+$ handling missing and noisy data. \hfill \m{6} \yr{79 Ba}
  \item Preprocessing $+$ \textbf{data sampling} $+$ dimensionality reduction w/ example. \hfill \m{2+4+4} \yr{73 Ch}
  \item How does real data become \textbf{asymmetric}? Symmetric vs asymmetric data. \hfill \m{5} \yr{73 Ch}
  \item What is dimensionality reduction and why does it matter? \hfill \m{5} \yr{70 Asa}
  \item Properties of a distance metric \gap (its second half is \S3.4). \hfill \m{10} \yr{70 Asa}
  \item Different data types w/ examples \yr{69 Ch} $\cdot$ short note \textbf{OLAP cubes} \yr{70 Asa}. \hfill \m{5}\m{5}
\end{itemize}
