...
\begin{itemize}
  ...
  \item \mk{Worked end to end on a fan-speed controller in the
        companion, \S6.N.12}; \textbf{\S6.N.13} builds that controller's variables,
        membership functions and rule base from a blank sheet, which is what
        \yr{\textbf{80 Ch}} and \yr{\texttt{82 Ba}} ask for instead of a run.
\end{itemize}}{%
