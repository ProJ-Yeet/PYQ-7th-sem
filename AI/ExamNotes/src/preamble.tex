% =====================================================================
%  Artificial Intelligence — Exam Notes : shared preamble
%  Lifted verbatim from Wireless\ExamNotes\src\preamble.tex; only the
%  tier-chip denominators (now /41) and the running header differ.
%  Year tags carry THREE axes, all set inside \yr{}:
%    \textbf{}  = Regular exam        plain = Back exam
%    \texttt{}  = CT 710  (BEI IV/I)  \textit{} = CT 78506 (BEX IV/II)
%    plain face = CT 653  (BCT III/II)
%  The same year code names different papers under different codes, so the
%  font is the only thing telling \textbf{77 Ch} from \textbf{\textit{77 Ch}}.
...
\newcommand{\tS}[1]{\pill{mkc}{white}{TOP\, #1/41}}            % 8+ papers
\newcommand{\tF}[1]{\pill{acc}{white}{HOT\, #1/41}}            % 4-7 papers
\newcommand{\tP}[1]{\pill{pin}{white}{PIN\, #1/41}}            % 1-3, >=6 marks
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\footnotesize\color{sub} Artificial Intelligence \textperiodcentered{} CT 710 / CT 653 / CT 78506}
