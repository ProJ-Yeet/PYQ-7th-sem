...
\end{itemize}}
% resgraph:c4_resg_01 (generated by resgraph.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=289.8pt]{figs/c4_resg_01.png}\end{center}
% resgraph:end
...
\end{itemize}}
% resgraph:c4_resg_02 (generated by resgraph.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=347.9pt]{figs/c4_resg_02.png}\end{center}
% resgraph:end
...
\end{itemize}}
% resgraph:c4_resg_03 (generated by resgraph.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=360.9pt]{figs/c4_resg_03.png}\end{center}
% resgraph:end
...
\begin{itemize}
  ...
  \item Same rules, same modus ponens, opposite ends. One sentence, and the comparison
        marks are secured.
\end{itemize}}
% chaingraph:c4_chain_west_fwd (generated by chaingraph.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=475.2pt]{figs/c4_chain_west_fwd.png}\end{center}
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=453.9pt]{figs/c4_chain_west_bwd.png}\end{center}
% chaingraph:end
...
\end{itemize}}
% resgraph:c4_resg_04 (generated by resgraph.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=364.6pt]{figs/c4_resg_04.png}\end{center}
% resgraph:end
...
\lead{FOPL}
\begin{itemize}
  \item[1.] $\forall x\; Pompeian(x) \rightarrow Roman(x)$
  \item[2.] $\forall x\; Roman(x) \rightarrow loyal(x, Caesar) \vee hate(x, Caesar)$
  \item[3.] $\forall x\, \exists y\; loyal(x, y)$
  \item[4.] $\forall x \forall y\; tryAssassinate(x,y) \wedge ruler(y) \rightarrow
            \neg loyal(x,y)$
  \item[5.] $tryAssassinate(Marcus, Caesar)$
  \item[6.] $Pompeian(Marcus)$ \qquad \textbf{7.} $ruler(Caesar)$ \hfill \yr{assumed}
  \item[] \textbf{Goal}: $hate(Marcus, Caesar)$
\end{itemize}
\lead{CNF}
\begin{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Clause 3 is never used}, and it is the only clause with a Skolem function
        ...
        proof needs it.
\end{itemize}}
% resgraph:c4_resg_05 (generated by resgraph.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=515.0pt]{figs/c4_resg_05.png}\end{center}
% resgraph:end
...
\lead{FOPL}
\begin{itemize}
  \item[1.] $\forall x\; child(x) \rightarrow loves(x, Santa)$
  \item[2.] $\forall x \forall y\; loves(x, Santa) \wedge reindeer(y) \rightarrow
            loves(x, y)$
  \item[3.] $reindeer(Rudolph)$ \qquad \textbf{4.} $redNose(Rudolph)$
  \item[5.] $\forall x\; redNose(x) \rightarrow weird(x) \vee clown(x)$
  \item[6.] $\forall x\; reindeer(x) \rightarrow \neg clown(x)$
  \item[7.] $\forall x\; weird(x) \rightarrow \neg loves(Scrooge, x)$
  \item[] \textbf{Goal}: $\neg child(Scrooge)$
\end{itemize}
{\color{sub}\footnotesize \emph{``No reindeer is a clown''} is
$\neg\exists x\,(reindeer(x) \wedge clown(x))$; pushing the $\neg$ in gives line 6.}
\lead{CNF}
\begin{itemize}
...
\end{itemize}}
% resgraph:c4_resg_06 (generated by resgraph.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=376.0pt]{figs/c4_resg_06.png}\end{center}
% resgraph:end
...
\sbsr{0.50}{%
\lead{FOPL \; \yr{(the 3 marks)}}
\begin{itemize}
  \item[A.] $\forall x\, \big[\forall y\; Animal(y) \rightarrow Loves(x,y)\big]
            \rightarrow \exists z\; Loves(z,x)$
  \item[B.] $\forall x\, \big[\exists y\; Animal(y) \wedge Kills(x,y)\big]
            \rightarrow \forall z\; \neg Loves(z,x)$
  \item[C.] $\forall x\; Animal(x) \rightarrow Loves(Jack, x)$
  \item[D.] $Kills(Jack, Tuna) \vee Kills(Curiosity, Tuna)$
  \item[E.] $Cat(Tuna)$ \qquad \textbf{F.} $\forall x\; Cat(x) \rightarrow Animal(x)$
            \hfill \yr{assumed}
  \item[] \textbf{Goal}: $Kills(Curiosity, Tuna)$
\end{itemize}
...
\end{itemize}}
% resgraph:c4_resg_07 (generated by resgraph.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=515.0pt]{figs/c4_resg_07.png}\end{center}
% resgraph:end
...
\lead{FOPL}
\begin{itemize}
  \item[1.] $\forall x\; pass(x) \wedge win(x) \rightarrow happy(x)$
  \item[2.] $\forall x\; study(x) \vee lucky(x) \rightarrow pass(x)$
  \item[3.] $\neg study(Sneha) \wedge lucky(Sneha)$
  \item[4.] $\forall x\; lucky(x) \rightarrow win(x)$
  \item[] \textbf{Goal}: $happy(Sneha)$
\end{itemize}
\lead{CNF}
\begin{itemize}
...
\end{itemize}}
% resgraph:c4_resg_08 (generated by resgraph.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=294.0pt]{figs/c4_resg_08.png}\end{center}
% resgraph:end
...
\lead{FOPL}
\begin{itemize}
  \item[1.] $\forall x\; easy(x) \rightarrow likes(Steve, x)$ \hfill \yr{converse reading}
  \item[2.] $\forall x\; science(x) \rightarrow \neg easy(x)$
  \item[3.] $\forall x\; basketWeaving(x) \rightarrow easy(x)$
  \item[4.] $basketWeaving(BK301)$
  \item[] \textbf{Goal}: $likes(Steve, BK301)$
\end{itemize}}{%
\lead{CNF and proof}
\begin{itemize}
...
\end{itemize}}
% resgraph:c4_resg_09 (generated by resgraph.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=270.0pt]{figs/c4_resg_09.png}\end{center}
% resgraph:end
...
\sbs{%
\lead{Into logic \; \yr{(propositional: no objects, so no quantifiers)}}
\begin{itemize}
  \item[1.] $sunny \wedge warm \rightarrow enjoy$
  \item[2.] $warm \wedge pleasant \rightarrow picking$
  \item[3.] $raining \rightarrow \neg picking$
  \item[4.] $raining \rightarrow wet$
  \item[5.] $warm$ \qquad \textbf{6.} $raining$ \qquad \textbf{7.} $sunny$
  \item[] \textbf{Goal}: $enjoy$
\end{itemize}
\lead{CNF}
\begin{itemize}
  \item[1.] $\neg sunny \vee \neg warm \vee enjoy$
...
\end{itemize}}
% resgraph:c4_resg_10 (generated by resgraph.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=224.1pt]{figs/c4_resg_10.png}\end{center}
% resgraph:end
...
\lead{FOPL}
\begin{itemize}
  \item[1.] $\forall x\; oversmart(x) \rightarrow stupid(x)$
  \item[2.] $\forall x \forall y\; child(x,y) \wedge oversmart(y) \rightarrow naughty(x)$
  \item[3.] $child(Ram, Hari)$ \qquad \textbf{4.} $oversmart(Hari)$
  \item[] \textbf{Goal}: $naughty(Ram)$
\end{itemize}
\lead{CNF}
\begin{itemize}
...
\end{itemize}}
% resgraph:c4_resg_11 (generated by resgraph.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=344.2pt]{figs/c4_resg_11.png}\end{center}
% resgraph:end
...
\lead{FOPL}
\begin{itemize}
  \item[1.] $\forall x \forall y\; onTop(x,y) \rightarrow supports(y,x)$
  \item[2.] $\forall x \forall y\; above(x,y) \wedge touching(x,y) \rightarrow onTop(x,y)$
  \item[3.] $above(Cup, Book)$ \qquad \textbf{4.} $touching(Cup, Book)$
  \item[] \textbf{Goal}: $supports(Book, Cup)$
\end{itemize}
\lead{CNF}
\begin{itemize}
...
\end{itemize}}
% resgraph:c4_resg_12 (generated by resgraph.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=391.7pt]{figs/c4_resg_12.png}\end{center}
% resgraph:end
...
\lead{FOPL}
\begin{itemize}
  \item[1.] $\forall x\; loves(Mary, x) \rightarrow star(x)$
  \item[2.] $\forall x\; student(x) \wedge \neg pass(x) \rightarrow \neg play(x)$
  \item[3.] $student(John)$
  \item[4.] $\forall x\; student(x) \wedge \neg study(x) \rightarrow \neg pass(x)$
...
\end{itemize}}
% resgraph:c4_resg_13 (generated by resgraph.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=310.1pt]{figs/c4_resg_13.png}\end{center}
% resgraph:end
...
\sbs{%
\lead{FOPL \; \yr{(the 5 marks begin here)}}
\begin{itemize}
  \item[1.] $\forall x\; \neg poor(x) \wedge smart(x) \rightarrow happy(x)$
  \item[2.] $\forall x\; read(x) \rightarrow \neg stupid(x)$
  \item[3.] $read(John) \wedge wealthy(John)$, i.e.\ $read(John) \wedge \neg poor(John)$
  \item[4.] $\forall x\; happy(x) \rightarrow exciting(x)$
  \item[5.] $\forall x\; \neg stupid(x) \rightarrow smart(x)$ \hfill \yr{bridge, stated}
  \item[] \textbf{Goal}: $\exists x\; exciting(x)$
\end{itemize}
...
\end{itemize}}
% resgraph:c4_resg_14 (generated by resgraph.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=257.7pt]{figs/c4_resg_14.png}\end{center}
% resgraph:end
