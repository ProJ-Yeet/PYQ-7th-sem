...
net-to-frame conversion and the net/frame/FOPL question. \gap$\cdot$\gap Every set is
answered as an \textbf{arc list} $-$ every node, every link, every direction $-$ and
\mk{the net drawn from that list}, in the paper's own words. The deck
and textbook figures for these sets use other names and values, so they are not printed
as answers.}
...
\begin{itemize}
  ...
  \item \textbf{Layout that always works}: most general class at the \textbf{top},
        ...
        their own properties fanning \textbf{sideways}. Every net in this chapter is
        drawn that way.
\end{itemize}
...
\end{itemize}}{%
\lead{The FOPL to write under the net}
\begin{itemize}
  \item \code{isa(Person, Mammal)}, \code{instance(Sakti Gauchan, Person)},
        \code{has-part(Person, Nose)}, \code{team(Sakti Gauchan, Nepalese team)},
        \code{uniform-color(Sakti Gauchan, Red/Blue)}.
  \item \mk{PS Sir's slide for this set is not the answer}: it draws
        \emph{Head} for the paper's \emph{nose} and \emph{Black/Blue} for
        \emph{Red/Blue}. Use the paper's words, as the net below does.
...
\end{itemize}}
% semnet:c5_net_01 (generated by semnet.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=287.1pt]{figs/c5_net_01.png}\end{center}
% semnet:end
...
\begin{itemize}
  ...
  \item \mk{The textbook figure of this set is not the answer}: it
        collapses the Adult Male / Baseball Player / Fielder spine and uses other
        property arcs. Draw the seven arcs of the table, as the net below does.
\end{itemize}}
% semnet:c5_net_02 (generated by semnet.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=188.4pt]{figs/c5_net_02.png}\end{center}
% semnet:end
...
\begin{itemize}
  ...
  \item \mk{BA Sir's slide for this set is not the answer}: it names the
        owner \emph{John} and leaves out \emph{Sudeep age is 20}.
  ...
  \begin{itemize}
    ...
    \item \emph{The cat sat on the mat} is about \textbf{the class} Cat as the net below
          draws it, but the sentence plainly means \emph{that} cat, ie Tom.
          \mk{Draw it on Cat and add a line saying the
...
\end{itemize}}
% semnet:c5_net_03 (generated by semnet.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=319.9pt]{figs/c5_net_03.png}\end{center}
% semnet:end
...
\end{itemize}}
% semnet:c5_net_04 (generated by semnet.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=373.6pt]{figs/c5_net_04.png}\end{center}
% semnet:end
...
\end{itemize}}
% semnet:c5_net_05 (generated by semnet.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=284.1pt]{figs/c5_net_05.png}\end{center}
% semnet:end
...
\end{itemize}}
% semnet:c5_net_06 (generated by semnet.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=241.9pt]{figs/c5_net_06.png}\end{center}
% semnet:end
...
\begin{itemize}
  ...
  \end{itemize}
\end{itemize}}
% semnet:c5_net_07 (generated by semnet.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=206.0pt]{figs/c5_net_07.png}\end{center}
% semnet:end
...
\end{itemize}}
% semnet:c5_net_08 (generated by semnet.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=220.4pt]{figs/c5_net_08.png}\end{center}
% semnet:end
...
\begin{itemize}
  ...
  \end{itemize}
\end{itemize}}{%
\lead{Notes to write beside the net}
\begin{itemize}
  ...
  \item \emph{Birds can fly} is on the class, so every bird inherits it. That is also the
        ...
        default.
\end{itemize}}
% semnet:c5_net_09 (generated by semnet.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=355.5pt]{figs/c5_net_09.png}\end{center}
% semnet:end
...
\begin{itemize}
  ...
  \item \mk{Close on the limitation}, because the question says
        ...
        negation.
\end{itemize}}
% semnet:c5_net_10 (generated by semnet.py; do not edit)
\penalty0\vspace{2pt}
\begin{center}\includegraphics[width=338.8pt]{figs/c5_net_10.png}\end{center}
% semnet:end
...
the set the textbook itself converts, and its finished frames are a published figure}
