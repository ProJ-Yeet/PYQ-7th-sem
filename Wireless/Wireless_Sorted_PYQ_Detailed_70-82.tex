...
\begin{itemize}[noitemsep]
  \item PYQs from TU, IOE, BEX (EX751) and BEI (EX715) programmes combined, 2070--2082 BS. 23 papers: 16 BEX (2070--2080) and 7 BEI (2079--2082).
  ...
  \subsection{Evolution of Wireless Communications (1G--5G)}
    \begin{enumerate}[topsep=0pt, noitemsep]
      \item Briefly explain evolution of wireless communications 1G--3G \hfill [6] (70 Ma, 72 Ma)
        ...
        \lb Evolution of different generations of cellular systems \hfill [4] (\bo{75 Bh}) [6] (\texttt{82 Ba})
...
\begin{center}(4 Hours)\end{center}
  ...
  \subsection{Frequency Reuse and Channel Assignment}
    \begin{enumerate}[topsep=0pt, noitemsep]
      ...
      \item Frequency reuse; various channel assignment strategies used in mobile
        communication \hfill [2+4] (\texttt{82 Ba})
  ...
  \subsection{Coverage and Capacity Enhancement}
    \begin{enumerate}[topsep=0pt, noitemsep]
      ...
      \item A single high-power transmitter supports 40 voice channels over an area of
        140 km² with the available spectrum. The area is divided equally into seven smaller
        cells, each served by a lower-power transmitter so that each cell supports 30\% of
        the total voice channels --- find (i) the coverage area of each cell, (ii) the total
        number of voice channels available in the cellular system compared with the
        non-cellular system \enter\hfill [1+3] (\texttt{82 Ba})
    \end{enumerate}
  ...
  \subsection{Outdoor Propagation Models}
    \begin{enumerate}[topsep=0pt, noitemsep]
      ...
      \item Okumura model: median path loss for T--R separation 50 km, transmit antenna
        ...
        \lb Okumura model, suburban, $d{=}50$ km, $h_{te}{=}100$ m, $h_{re}{=}10$ m, BS radiating
        EIRP of 1 kW at 900 MHz --- find the median path loss and the power at the receiver
        for a unity-gain receiving antenna, $A_{mu} = 43$ dB, $G_{AREA} = 9$ dB
        \enter\hfill [8] (\texttt{82 Ba})
  ...
  \subsection{Small Scale Fading, Multipath Parameters, Doppler}
    \begin{enumerate}[topsep=0pt, noitemsep]
      ...
      \item Doppler spread; types of small-scale fading based on Doppler spread; mean excess
        ...
        \begin{center}\includegraphics[width=3.2in]{images/wl_70ma_pdp.png}\end{center}
      \item Coherence bandwidth and coherence time --- definitions and significance in
        ...
        \lb Coherence bandwidth and coherence time, and their significance in mobile radio
        propagation; fading and its various types \hfill [3+5] (\texttt{82 Ba})
  ...
  \subsection{M-ary Modulation (MPSK, MFSK, QAM) and OFDM}
    \begin{enumerate}[topsep=0pt, noitemsep]
      \item OFDM operation +Fig (block diagram of transmitter \& receiver)
        \hfill [8] (\bo{74 Bh}, \bo{\texttt{80 Bh}}, \bo{78 Ch}, \texttt{82 Ba})
  ...
  \subsection{Equalization: Linear, Non-linear, Adaptive}
    \begin{enumerate}[topsep=0pt, noitemsep]
      \item Equalization (I) in wireless communication; describe the signal processing operation
        ...
        \lb Signal processing operation that minimizes ISI; RAKE receiver; working of an
        M-branch RAKE receiver \hfill [2+2+4] (\texttt{82 Ba})
  ...
  \subsection{Speech Characteristics, Frequency Domain Coding, Vocoders}
    \begin{enumerate}[topsep=0pt, noitemsep]
      ...
      \item Vocoder (I); explain any two predictive coders \hfill [2+6] (\bo{70 Bh})
        ...
        \lb Characteristics of speech signals; basic working principle of the Formant and
        Channel vocoder \hfill [4+4] (\texttt{82 Ba})
  ...
  \subsection{Spread Spectrum Multiple Access: CDMA, FHMA, Hybrids}
    \begin{enumerate}[topsep=0pt, noitemsep]
      ...
      \item FHMA working with +Eg \hfill [4] (\bo{\texttt{79 Bh}})
        ...
        \lb (+) of CDMA over TDMA; Frequency Hopping Spread Spectrum (FHSS) multiple access
        technique +Fig; different types of FHSS \hfill [4+6+2] \mbox{(\texttt{82 Ba})}
  ...
  \subsection{GSM: Architecture and Channels}
    \begin{enumerate}[topsep=0pt, noitemsep]
      ...
      \item GSM traffic \& control channels \hfill [8] (\bo{75 Bh}, \bo{72 Ash}, \bo{78 Ch})
        ...
        \lb Types of control channels available in GSM and their purposes \hfill [2+4] (\texttt{82 Ba})
  ...
  \subsection{CDMA Standards: IS-95 Forward and Reverse Channels}
    \begin{enumerate}[topsep=0pt, noitemsep]
      \item Channelization code; forward channels in cdma IS-95 \hfill [4] (73 Ma)
        \lb Draw the forward CDMA (IS-95) channel \hfill [4] (\bo{\texttt{80 Bh}}) [4] (\bo{78 Ch}) [6] (\bo{80 Ch}, \texttt{82 Ba})
