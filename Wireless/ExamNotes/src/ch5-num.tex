...
{\color{sub}\footnotesize \mk{No PYQ in 23 papers has set a pure calculation on this chapter.}
...
23 papers; this is the arithmetic that answers it with a number. \added}
