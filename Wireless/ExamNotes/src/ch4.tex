...
\mk{MSK and GMSK together are asked in 6 of 23 papers}}
...
air interface of WiFi, WiMAX, LTE and 5G, and it is asked in \mk{9 of the 23 papers} here,
always with a block diagram attached.}

\Q{OFDM operation, block diagram of transmitter and receiver}{\m{4}\m{8}}
{\color{sub}\footnotesize \tS{10} \yr{\textbf{74 Bh} \m{8}, \textbf{\texttt{80 Bh}} \m{8},
...
\texttt{82 Ba} \m{8}}
\gap$\cdot$\gap \mk{10 of 23 papers. Nothing else in the chapter comes close.}}
...
\mk{spread spectrum overall: 7 of 23 papers}}
