...
{\color{sub}\footnotesize 9 hrs \gap$\cdot$\gap asked in \mk{all 22 papers}
...
\Q{Explain the operation of FHMA with transmitter and receiver block diagrams; types of FHMA}{\m{3}\m{4}\m{5}\m{6}\m{7}}
{\color{sub}\footnotesize \tS{10} \yr{\textbf{\texttt{81 Bh}} \m{4+2},
...
\mk{10 of 22 papers} \gap$\cdot$\gap the marks are in the two block diagrams}
...
\Q{What is CDMA? Its characteristics, features, advantages and limitations}{\m{2}\m{4}\m{6}\m{2+6}}
{\color{sub}\footnotesize \tS{9} \yr{\textbf{\texttt{79 Bh}} \m{2+6}, \textbf{70 Bh} \m{6},
...
\mk{9 of 22 papers, and it is nearly always bolted onto the FHMA question}
