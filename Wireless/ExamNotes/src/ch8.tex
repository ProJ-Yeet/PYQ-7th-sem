...
{\color{sub}\footnotesize 6 hrs \gap$\cdot$\gap asked in \mk{22 of 23 papers}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \textbf{GSM traffic and control channels} \tS{9} $\rightarrow$ the BCH / CCCH /
...
\Q{Explain the working of all traffic and control channels used in GSM}{\m{4}\m{5}\m{6}\m{8}\m{4+4}\m{2+4}}
{\color{sub}\footnotesize \tS{9} \yr{\textbf{\texttt{81 Bh}} \m{8} (control channels), \texttt{82 Ba} \m{2+4} (types $+$ purposes),
...
{\color{sub}\footnotesize \tS{7} \yr{\textbf{\texttt{80 Bh}} \m{4}, \textbf{80 Ch} \m{6}, \texttt{82 Ba} \m{6},
...
syllabus item \textbf{8(a)}, \mk{never examined in 23 papers} \gap$\cdot$\gap
