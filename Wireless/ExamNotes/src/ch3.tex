...
\gap$\cdot$\gap asked in \textbf{23 of 23 papers} \gap$\cdot$\gap 7 syllabus sub-topics
...
\begin{itemize}
  ...
  \item Three questions are near-certain:
        \textbf{small-scale fading types + factors} \tS{7},
        \textbf{coherence bandwidth and coherence time} \tS{6}, and an
        \textbf{Okumura or Hata numerical} \tF{5}.
...
\mk{the numerical version appears in 13 of 23 papers} $\rightarrow$ Ch 3 companion}
...
\Q{Explain the parameters of the mobile multipath channel}{\m{7}\m{4}\m{2+4}\m{3+5}}
{\color{sub}\footnotesize \tF{4} \yr{71 Ma, \textbf{\texttt{80 Bh}}, 70 Ma, \texttt{82 Ba} \m{3+5}}
\gap$\cdot$\gap 80 Bh asks which parameters are used to \mk{classify the types of fading}
\gap$\cdot$\gap 82 Ba asks coherence bandwidth and coherence time with their significance,
then fading and its types
...
\Q{Explain the types of small-scale fading}{\m{4+4}\m{1+3}\m{2+7}\m{2+4}\m{3+5}}
{\color{sub}\footnotesize \tS{7} \yr{70 Ma, 74 Ma, \textbf{79 Ch}, \texttt{81 Ba},
\textbf{80 Ch}, \textbf{\texttt{80 Bh}}, \texttt{82 Ba} \m{3+5}} \gap$\cdot$\gap
