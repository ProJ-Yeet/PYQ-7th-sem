...
{\color{sub}\footnotesize 2 hrs \gap$\cdot$\gap asked in \mk{all 23 papers}
...
{\color{sub}\footnotesize \tS{11} \yr{70 Ma \m{6}, 72 Ma \m{6}, \textbf{71 Bh} \m{4},
74 Ma \m{4}, \textbf{75 Bh} \m{4}, 71 Ma \m{4}, \textbf{73 Bh} \m{4}, \textbf{76 Bh} \m{6},
\textbf{78 Ch} \m{4}, \textbf{\texttt{81 Bh}} \m{2+4}, \texttt{82 Ba} \m{6}} \gap$\cdot$\gap
