...
{\color{sub}\footnotesize 4 hrs \gap$\cdot$\gap asked in \mk{22 of 23 papers}
...
\begin{itemize}
  \item \textbf{Equalization} \tS{16} and \textbf{diversity} \tS{11} are two of the three most
        reliable questions in the whole paper. \textbf{RAKE} \tS{7} is close behind.
...
\Q{Why is equalization needed? Describe the signal processing operation that minimizes ISI}{\m{2+6}\m{2+5}\m{4}\m{2+1+4}\m{2+2+4}}
{\color{sub}\footnotesize \tS{7} \yr{72 Ma, 73 Ma, \textbf{75 Bh}, \textbf{73 Bh},
\textbf{\texttt{82 Bh}}, \texttt{80 Ba}, \texttt{82 Ba} \m{2+2+4}} \gap$\cdot$\gap \mk{the highest-frequency question in
the chapter}}
...
\Q{Explain the working of an M-branch RAKE receiver with a block diagram}{\m{8}\m{3+5}\m{4}\m{3}\m{2+2+4}}
{\color{sub}\footnotesize \tS{7} \yr{70 Ma, \textbf{72 Ash}, \textbf{73 Bh}, \textbf{76 Bh},
\textbf{77 Ch}, \texttt{79 Bh}, \texttt{82 Ba} \m{2+2+4}} \gap$\cdot$\gap 73 Bh asks
