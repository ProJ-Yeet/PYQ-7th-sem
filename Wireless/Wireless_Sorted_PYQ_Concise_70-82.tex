...
\begin{itemize}
  \item Frequency reuse; co-channel reuse ratio in detail; minimizing reuse distance maximizes spectral efficiency (I); cellular concept for $N{=}7$ \hfill (6)(4)(3)
...
\begin{itemize}
  ...
  \item Coherence BW \& coherence time --- definition and significance; Doppler spread + classify fading by rms delay spread and coherence time; frequency-selective fading, coherence BW Vs delay spread \hfill (4)(2+5)(4+4)(2+7)
    \begin{itemize}
...
\begin{itemize}
  ...
  \item Vocoder (I) + any two predictive coders; vocoders +Fig and their kinds; vocoder operation +Fig; formant vocoder + speech characteristics; why speech coding is needed + basic VOCODER concept \hfill (4)(6)(2+3)(2+6)(3+5)(4+4)
...
\begin{itemize}
  ...
  \item FHMA --- working +Eg; Tx \& Rx +block diagram; operation + types of FHMA; principle + two hybrid SSMA techniques mitigating the near-far problem \hfill (4)(5)(6)(7)(4+2)(4+6)
...
\begin{itemize}
  ...
  \item GSM traffic \& control channels; BCH \& CCCH; Broadcast Control Channel; operation of the different control channels \hfill (4+4)(5)(8)
