...
\begin{itemize}[noitemsep]
  ...
  \item Chapters 1 and 9 are asked almost exclusively by EX753; CT704 never sets a sampling/quantization or DSP-processor question. Everything in between is common ground.
...
%=======================================================================
\section{Introduction to DSP, Sampling and Quantization}
\begin{center}(EX753 only --- CT704 does not set this chapter)\end{center}

  \subsection{Basic elements, advantages, disadvantages, applications}
    \begin{enumerate}[topsep=0pt, noitemsep]
      ...
      \item Explain the general application areas of digital Signal Processing. \hfill [3] (\bo{\texttt{73 Bh}})
        ...
        \lb What are the applications of DSP? (asked as the lead-in to the sampling numericals below.) \hfill [2] (\bo{\texttt{79 Ch}, \texttt{72 Ash}}, \texttt{72 Ma})
    \end{enumerate}

  \subsection{Sampling theorem, Nyquist rate, aliasing}
    \begin{enumerate}[topsep=0pt, noitemsep]
  ...
  \subsection{Direct form, cascade and parallel realizations}
    \begin{enumerate}[topsep=0pt, noitemsep]
      ...
      \item Realize the given system in cascade form of second-order sections (signal flow graph):
        \lb $H(z)=\dfrac{10(1-0.25z^{-1})(1-0.667z^{-1})(1+2z^{-1})}{(1-0.75z^{-1})(1-0.125z^{-1})\{1-(0.5+j0.5)z^{-1}\}\{1-(0.5-j0.5)z^{-1}\}}$ \hfill [5] (81 Ba)
        \lb Cascaded \emph{and parallel} form of $H(z)=\dfrac{5(1-0.25z^{-1})(1-0.667z^{-1})(1+2z^{-1})}{(1-0.75z^{-1})(1-0.125z^{-1})[1-(0.5+j0.5)z^{-1}][1-(0.5-j0.5)z^{-1}]}$ \hfill [7] (\texttt{74 Ma})
        \lb $H(z)=\dfrac{(1-0.4z^{-1})(1+0.2z^{-1})(1-0.3e^{j\pi/6}z^{-1})(1-0.3e^{-j\pi/6}z^{-1})}{(1-0.5e^{j\pi/3}z^{-1})(1-0.5e^{-j\pi/3}z^{-1})(1+0.7e^{j\pi/4}z^{-1})(1+0.7e^{-j\pi/4}z^{-1})}$ \hfill [4] (80 Ba)
        \lb $H(z)=\dfrac{(1-0.5z^{-1})(1+0.35z^{-1})(1-0.3e^{j2n\pi/5}z^{-1})(1-0.3e^{-j2n\pi/5}z^{-1})}{(1-0.6e^{jn\pi/3}z^{-1})(1-0.6e^{-jn\pi/3}z^{-1})(1+0.5e^{j2n\pi/7}z^{-1})(1+0.5e^{-j2n\pi/7}z^{-1})}$ \hfill [4] (\bo{76 Ch})
        ...
        \lb $H(z)=\dfrac{(1-\tfrac13 z^{-1})(1-\tfrac14 z^{-1})(1-\tfrac18 z^{-1})}{(1-\tfrac56 z^{-1})(1-\tfrac16 z^{-1})(1-\tfrac34 e^{-j\pi/4}z^{-1})(1-\tfrac34 e^{+j\pi/4}z^{-1})}$; draw the block diagram of the cascade realization. (The paper prints the last factor with a $-j\pi/4$ exponent twice; the conjugate is meant.) \hfill (marks clipped in the scan) (\bo{67 Mng})
...
\pagebreak
%=======================================================================
\section{DSP Processors and Implementation}
\begin{center}(EX753 only --- CT704 does not set this chapter)\end{center}
