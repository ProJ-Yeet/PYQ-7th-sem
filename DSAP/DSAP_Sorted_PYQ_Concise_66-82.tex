...
Ch.\ 1 and 9 are \texttt{EX753} only.
\vspace{2pt}
\hrule
\vspace{4pt}
...
\section*{1. Intro to DSP, Sampling \& Quantization \textnormal{(\texttt{EX753})}}
\begin{itemize}
...
\section*{2. Discrete-Time Signals \& Systems}
\begin{itemize}
...
\section*{4. Analysis of LTI in Frequency Domain}
\begin{itemize}
...
\section*{5. Discrete Filter Structures}
\begin{itemize}
...
\section*{8. Discrete Fourier Transform (DFT / FFT)}
\begin{itemize}
...
\section*{9. DSP Processors \textnormal{(\texttt{EX753})}}
\begin{itemize}
