...
\gap$\cdot$\gap worked instances in \textbf{Ch1-num \S1}}
...
\gap$\cdot$\gap the plotting half is done in \textbf{Ch1-num \S2}}
...
\gap$\cdot$\gap \textbf{always paired with \S1.4} \gap$\cdot$\gap worked in \textbf{Ch1-num \S3}}
...
it as the second half of the energy/power question \gap$\cdot$\gap worked in \textbf{Ch1-num \S4}}
...
\textbf{Ch 3}, the response half is worked in \textbf{Ch1-num \S6}}
...
paper}, see the shortcut \gap$\cdot$\gap worked in \textbf{Ch1-num \S7}}
