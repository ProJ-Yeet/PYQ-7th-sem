...
\creamq{Every other FFT paper}{}
{\color{sub}\footnotesize Same recipe, different sequences. \mk{DIT and DIF give the
same $X(k)$}, so the algorithm column records only what the paper asked for. Sequences
shorter than $N$ are zero padded, which is shown as printed.}
\par\smallskip
{\footnotesize
\begin{tabular}{@{}L{1.7cm}L{0.4cm}L{0.7cm}L{3.9cm}L{7.4cm}@{}}
\toprule
\hrow \thead{Papers} & \thead{$N$} & \thead{Alg} & \thead{$x[n]$ as printed}
& \thead{$X(k)$} \\
80 Bh & 8 & DIF & \{$2$, $1$, $2$, $1$, $1$, $2$, $1$, $2$\} & \{$12$, $1{+}j0.4142$, $0$, $1{+}j2.414$, $0$, $1{-}j2.414$, $0$, $1{-}j0.4142$\} \\
78 Bh & 8 & DIT & \{$1$, $1$, $1$, $1$, $0$, $0$, $0$, $0$\} & \{$4$, $1{-}j2.414$, $0$, $1{-}j0.4142$, $0$, $1{+}j0.4142$, $0$, $1{+}j2.414$\} \\
81 Bh & 8 & DIT & \{$1$, $-2$, $-4$, $3$, $0$, $1$\} & \{$-1$, $-3.243{+}j4$, $5{+}j4$, $5.243{-}j4$, $-5$, $5.243{+}j4$, $5{-}j4$, $-3.243{-}j4$\} \\
79 Ba & 8 & DIF & \{$1$, $2$, $4$, $3$, $5$, $-1$, $3$\} & \{$17$, $-4{-}j5.243$, $-1{+}j2$, $-4{-}j3.243$, $9$, $-4{+}j3.243$, $-1{-}j2$, $-4{+}j5.243$\} \\
76 Ch & 8 & DIF & \{$1$, $2$, $3$, $3$, $5$, $0$, $4$, $6$\} & \{$24$, $-0.4645{+}j1.707$, $-1{+}j7$, $-7.536{-}j0.2929$, $2$, $-7.536{+}j0.2929$, $-1{-}j7$, $-0.4645{-}j1.707$\} \\
76 Ash & 8 & DIF & \{$1$, $2$, $3$, $3$, $5$, $1$, $4$, $2$\} & \{$21$, $-4{-}j0.4142$, $-1{+}j2$, $-4{-}j2.414$, $5$, $-4{+}j2.414$, $-1{-}j2$, $-4{+}j0.4142$\} \\
82 Bh & 8 & DIT & \{$1$, $0.5$, $-1$, $-0.5$, $2$, $-1.5$\} & \{$0.5$, $0.7678{-}j0.06066$, $4{+}j0.5$, $-2.768{-}j2.061$, $3.5$, $-2.768{+}j2.061$, $4{-}j0.5$, $0.7678{+}j0.06066$\} \\
75 Ash & 8 & DIT & \{$1$, $2$, $3$, $4$, $5$, $6$, $7$, $8$\} & \{$36$, $-4{+}j9.657$, $-4{+}j4$, $-4{+}j1.657$, $-4$, $-4{-}j1.657$, $-4{-}j4$, $-4{-}j9.657$\} \\
74 Ch & 8 & DIF & \{$1.5$, $-1$, $1.8$, $0.6$, $3$, $1.7$\} & \{$7.6$, $-3.833{-}j0.3151$, $2.7{-}j0.1$, $0.8335{+}j3.285$, $5$, $0.8335{-}j3.285$, $2.7{+}j0.1$, $-3.833{+}j0.3151$\} \\
\bottomrule
\end{tabular}}
\par\smallskip
{\footnotesize
...
\hrow \thead{Papers} & \thead{$N$} & \thead{Alg} & \thead{$x[n]$ as printed}
& \thead{$X(k)$} \\
74 Ash, \texttt{70 Bh} & 8 & DIF & \{$0.5$, $0.5$, $0.5$, $0.5$, $0$, $0$, $0$, $0$\} & \{$2$, $0.5{-}j1.207$, $0$, $0.5{-}j0.2071$, $0$, $0.5{+}j0.2071$, $0$, $0.5{+}j1.207$\} \\
\texttt{81 Ch} & 8 & DIF & \{$-0.5$, $-0.5$, $0.5$, $0.5$, $0$, $0$, $0$, $0$\} & \{$0$, $-1.207{-}j0.5$, $-1{+}j1$, $0.2071{+}j0.5$, $0$, $0.2071{-}j0.5$, $-1{-}j1$, $-1.207{+}j0.5$\} \\
73 Ch & 8 & DIF & \{$1$, $-1$, $3$, $2$, $1$, $1$, $3$, $-2$\} & \{$8$, $-4.243{-}j1.414$, $-4$, $4.243{-}j1.414$, $8$, $4.243{+}j1.414$, $-4$, $-4.243{+}j1.414$\} \\
73 Shr & 8 & DIT & \{$1$, $-1$, $2$, $2$, $1$, $1$, $2$, $2$\} & \{$10$, $-1.414{+}j1.414$, $-2{+}j4$, $1.414{+}j1.414$, $2$, $1.414{-}j1.414$, $-2{-}j4$, $-1.414{-}j1.414$\} \\
72 Ch & 8 & DIT & \{$1$, $1$, $2$, $4$, $3$, $1$, $2$, $1$\} & \{$15$, $-4.121{-}j2.121$, $j3$, $0.1213{-}j2.121$, $1$, $0.1213{+}j2.121$, $-j3$, $-4.121{+}j2.121$\} \\
72 Ka & 8 & DIT & \{$1$, $1$, $0$, $1$, $0$, $1$, $2$\} & \{$6$, $0.2929{+}j1.293$, $-1{-}j1$, $1.707{-}j2.707$, $0$, $1.707{+}j2.707$, $-1{+}j1$, $0.2929{-}j1.293$\} \\
71 Shr, \texttt{71 Bh} & 8 & DIT & \{$1$, $1$, $2$, $0$, $1$, $2$, $0$, $1$\} & \{$8$, $-j0.5858$, $-j2$, $j3.414$, $0$, $-j3.414$, $j2$, $j0.5858$\} \\
69 Ch & 8 & DIF & \{$1$, $1$, $2$, $2$, $1$, $1$, $2$, $1$\} & \{$11$, $-0.7071{-}j0.7071$, $-2{+}j1$, $0.7071{-}j0.7071$, $1$, $0.7071{+}j0.7071$, $-2{-}j1$, $-0.7071{+}j0.7071$\} \\
\texttt{80 Ch}, \texttt{73 Bh} & 8 & DIT & \{$1$, $0$, $2$, $0$, $-1$, $1$, $1$\} & \{$4$, $1.293{-}j0.2929$, $-3{-}j1$, $2.707{+}j1.707$, $2$, $2.707{-}j1.707$, $-3{+}j1$, $1.293{+}j0.2929$\} \\
\texttt{72 Ma} & 8 & DIF & \{$1$, $0$, $0$, $0$, $-1$, $1$, $1$\} & \{$2$, $1.293{+}j1.707$, $-1{-}j1$, $2.707{-}j0.2929$, $0$, $2.707{+}j0.2929$, $-1{+}j1$, $1.293{-}j1.707$\} \\
\texttt{74 Bh} & 8 & DIT & \{$1$, $1$, $0$, $0$, $0$\} & \{$2$, $1.707{-}j0.7071$, $1{-}j1$, $0.2929{-}j0.7071$, $0$, $0.2929{+}j0.7071$, $1{+}j1$, $1.707{+}j0.7071$\} \\
\texttt{73 Ma} & 8 & DIT & \{$1$, $-1$, $2$\} & \{$2$, $0.2929{-}j1.293$, $-1{+}j1$, $1.707{+}j2.707$, $4$, $1.707{-}j2.707$, $-1{-}j1$, $0.2929{+}j1.293$\} \\
\texttt{74 Ma} & 8 & DIT & \{$1$, $1$, $0$, $-1$, $2$\} & \{$3$, $0.4142$, $3{-}j2$, $-2.414$, $3$, $-2.414$, $3{+}j2$, $0.4142$\} \\
\bottomrule
\end{tabular}}
