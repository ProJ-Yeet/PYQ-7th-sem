...
Plot the pole-zero in the z-plane and draw the magnitude response (not to scale) of the
system described by the difference equation
$y[n]-0.4y[n-1]+0.25y[n-2]=x[n]+0.5x[n-1]$ (magnitude response only).
\end{asked}
...
\par\smallskip
{\footnotesize
\begin{tabular}{@{}L{2.45cm}L{4.45cm}L{2.55cm}L{2.35cm}L{1.5cm}L{1.85cm}@{}}
\toprule
\hrow \thead{Papers} & \thead{Difference equation} & \thead{Zeros} & \thead{Poles ($|p|$)}
& \thead{$|H|$ at $0,\frac{\pi}{2},\pi$} & \thead{Character} \\
\textbf{80 Bh} & $y(n)=x(n)+0.8x(n{-}1)$ \newline $+\,0.8x(n{-}2)+0.49y(n{-}2)$
  & $-0.4\pm j0.8$ \newline $(0.894)$ & $\pm0.7$ \newline $(0.7)$
  & $5.10$ \newline $0.55$ \newline $1.96$ & low-pass, dip at $116^{\circ}$ \\
\textbf{79 Bh} & $y[n]-0.35y[n{-}1]+0.25y[n{-}2]$ \newline $=x[n]-0.75x[n{-}1]$
  & $0.75$, $0$ & $0.175\pm j0.468$ \newline $(0.5)$
  & $0.28$ \newline $1.51$ \newline $1.09$ & high-pass, peak $1.53$ at $83^{\circ}$ \\
79 Ba & $y[n]-0.3y[n{-}1]+0.2y[n{-}2]$ \newline $=x[n]-0.5x[n{-}1]$
  & $0.5$, $0$ & $0.15\pm j0.421$ \newline $(0.447)$
  & $0.56$ \newline $1.31$ \newline $1.00$ & high-pass, peak $1.31$ at $85^{\circ}$ \\
74 Ash & $y[n]-0.4y[n{-}1]+0.2y[n{-}2]=x[n]$ \newline $+0.5x[n{-}1]+0.6x[n{-}2]+0.8x[n{-}3]$
  & $0.185\pm j0.942$ \newline $(0.96)$, $-0.869$ & $0.2\pm j0.4$ \newline $(0.447)$
  & $3.63$ \newline $0.56$ \newline $0.19$ & low-pass, dip at $79^{\circ}$ \\
72 Ka & $y[n]-0.5y[n{-}1]+0.3y[n{-}2]$ \newline $=x[n]+0.7x[n{-}1]$
  & $-0.7$, $0$ & $0.25\pm j0.487$ \newline $(0.548)$
  & $2.13$ \newline $1.42$ \newline $0.17$ & low-pass, peak $2.44$ at $50^{\circ}$ \\
\textbf{72 Ch} & $y[n]-0.4y[n{-}1]+0.1y[n{-}2]$ \newline $=x[n]+0.6x[n{-}1]$
  & $-0.6$, $0$ & $0.2\pm j0.245$ \newline $(0.316)$
  & $2.29$ \newline $1.18$ \newline $0.27$ & low-pass \\
\textbf{70 Ch} & $y[n]-0.3y[n{-}1]+0.225y[n{-}2]$ \newline $=x[n]+0.5x[n{-}1]$
  & $-0.5$, $0$ & $0.15\pm j0.45$ \newline $(0.474)$
...
\hrow \thead{Papers} & \thead{Difference equation} & \thead{Zeros} & \thead{Poles ($|p|$)}
& \thead{$|H|$ at $0,\frac{\pi}{2},\pi$} & \thead{Character} \\
\textbf{\texttt{71 Bh}} & $y[n]-0.3y[n{-}1]+0.225y[n{-}2]$ \newline $=x[n]-0.4x[n{-}1]$
  & $0.4$, $0$ & $0.15\pm j0.45$ \newline $(0.474)$
  & $0.65$ \newline $1.30$ \newline $0.92$ & high-pass, peak $1.32$ at $81^{\circ}$ \\
\texttt{73 Ma} & $y[n]-0.3y[n{-}1]+0.2y[n{-}2]$ \newline $=x[n]+0.7x[n{-}1]$
  & $-0.7$, $0$ & $0.15\pm j0.421$ \newline $(0.447)$
  & $1.89$ \newline $1.43$ \newline $0.20$ & low-pass, peak $2.00$ at $48^{\circ}$ \\
\textbf{69 Ch} & $y[n]-0.4y[n{-}1]+0.2y[n{-}2]=x[n]$ \newline $+0.1x[n{-}1]-0.06x[n{-}2]$
  & $-0.3$, $0.2$ & $0.2\pm j0.4$ \newline $(0.447)$
  & $1.30$ \newline $1.19$ \newline $0.53$ & low-pass, peak $1.51$ at $55^{\circ}$ \\
\textbf{\texttt{76 Bh}} & $y[n]-0.6y[n{-}1]+0.35y[n{-}2]=x[n]$ \newline $-0.1x[n{-}1]-0.2x[n{-}2]$
  & $0.5$, $-0.4$ & $0.3\pm j0.510$ \newline $(0.592)$
  & $0.93$ \newline $1.36$ \newline $0.46$ & band-pass, peak $1.91$ at $61^{\circ}$ \\
\textbf{75 Ch} & $y(n)-0.3y(n{-}1)=4x(n)$ \newline $+0.7x(n{-}1)+2x(n{-}2)$
  & $-0.0875\pm j0.702$ \newline $(0.707)$ & $0.3$ \newline $(0.3)$
  & $9.57$ \newline $2.03$ \newline $4.08$ & low-pass, dip at $99^{\circ}$ \\
\textbf{\texttt{69 Bh}} & $y[n]=x[n]+1.21x[n{-}2]$ \newline $-\,0.8y[n{-}1]$
  & $\pm j1.1$ \newline $(1.1)$ & $-0.8$ \newline $(0.8)$
  & $1.23$ \newline $0.16$ \newline $11.05$ & high-pass, deep dip at $90^{\circ}$ \\
70 Asa, \texttt{70 Ma} & $y(n)=x(n)+x(n{-}2)$ \newline (FIR, no feedback)
...
\par\smallskip
{\footnotesize
\begin{tabular}{@{}L{3.3cm}L{3.9cm}L{3.5cm}L{1.6cm}L{3.0cm}@{}}
\toprule
\hrow \thead{Papers} & \thead{Poles ($|p|$)} & \thead{Zeros ($|z|$)}
& \thead{$|H|$ at $0,\frac{\pi}{2},\pi$} & \thead{Shape} \\
82 Ba, 80 Ba, \textbf{82 Bh} & $0.45\pm j1.6$ \newline $(1.662)$
  & $0.58\pm j2.06$ \newline $(2.140)$ & $1.54$ \newline $1.90$ \newline $1.45$
  & shallow bump, peak $2.04$ at $74^{\circ}$ \\
\textbf{76 Ch}, 75 Ash, \textbf{\texttt{81 Ch}}, \textbf{\texttt{73 Bh}}
  & $0.45\pm j1.06$ \newline $(1.152)$ & $0.58\pm j2.06$ \newline $(2.140)$
  & $3.10$ \newline $3.93$ \newline $2.09$ & \mk{real peak} $11.50$ at $67^{\circ}$ \\
\textbf{74 Ch} & $0.45-j0.77$ \newline $(0.892)$, $-2\pm j0.3$ \newline $(2.022)$
  & none & $0.20$ \newline $0.18$ \newline $0.63$ & rises towards $\omega=\pi$ \\
\textbf{\texttt{75 Bh}}, \textbf{71 Ch} & $0.45\mp j0.77$ \newline $(0.892)$,
  $-2\pm j0.3$ \newline $(2.022)$ & $1.2\pm j3$ \newline $(3.231)$
  & $1.81$ \newline $1.76$ \newline $8.76$ & high-pass, peak $8.76$ at $\pi$ \\
\textbf{73 Ch} & $0.45+j0.77$ \newline $(0.892)$, $2\pm j0.7$ \newline $(2.119)$
  & $1.2\pm j0.43$ \newline $(1.275)$ & $0.27$ \newline $0.43$ \newline $0.37$
