...
\begin{itemize}
  ...
  \item \mk{A textbook difference worth knowing.} Oppenheim places the 3 dB point so the
        \emph{stopband} is met exactly, giving $\Omega_c=0.76627$ and a different
...
\begin{itemize}
  ...
  \item \mk{Both denominator coefficients are positive}, which in \S1 never happened.
        The poles are at $-0.956\pm j0.110$, near $z=-1$: sampling a 20 rad/s filter at
...
\begin{itemize}
  ...
  \item[] \[ \alpha=-\frac{\cos\frac{\omega_c+\omega'_c}{2}}
             ...
             =-\frac{0.56928}{0.98788}=\mathbf{-0.57658} \]
